...
def move_player(option):
    ...
    return yi, xi, ym, xm, yb, xb, yc, xc
...
def collect(option):
    ...
    for i in moves:
        if i == 'right':
            ...
            if world[yi][xi] == world[9][5] or world[yi][xi] == world[10][5] or world[yi][xi] == world[11][5] and i == 'extract' or world[yi][xi] == world[12][5] and i == 'extract':
                world[yi][xi] = Back.LIGHTWHITE_EX + '    '
                countwood += 1
            elif world[yi][xi] == world[9][5] or world[yi][xi] == world[10][5] or world[yi][xi] == world[11][5] or world[yi][xi] == world[12][5] and i == 'extract':
                world[yi][xi] = Back.LIGHTWHITE_EX + '    '
                countwood += 1
            elif world[yi][xi] == world[10][29] or world[yi][xi] == world[11][29] or world[yi][xi] == world[12][29] and i == 'extract':
                world[yi][xi] = Back.LIGHTWHITE_EX + '    '
                countwood += 1
            elif world[yi][xi] == world[10][25] or world[yi][xi] == world[11][25] or world[yi][xi] == world[12][25] and i == 'extract':
                world[yi][xi] = Back.LIGHTWHITE_EX + '    '
                countwood += 1
            elif world[yi][xi] == world[7][22] or world[yi][xi] == world[8][22] or world[yi][xi] == world[9][22] or world[yi][xi] == world[10][22] or world[yi][xi] == world[11][22] or world[yi][xi] == world[12][22] and i == 'extract':
                world[yi][xi] = Back.LIGHTWHITE_EX + '    '
                countwood += 1
            elif world[yi][xi] == world[9][17] or world[yi][xi] == world[10][17] or world[yi][xi] == world[11][17] or world[yi][xi] == world[12][17] and i == 'extract':
                world[yi][xi] = Back.LIGHTWHITE_EX + '    '
                countwood += 1
            elif world[yi][xi] == world[9][11] or world[yi][xi] == world[10][11] or world[yi][xi] == world[11][11] or  world[yi][xi] == world[12][11] and i == 'extract':
                world[yi][xi] = Back.LIGHTWHITE_EX + '    '
                countwood += 1
            elif world[yi][xi] == world[12][7] or world[yi][xi] == world[11][7] or world[yi][xi] == world[12][8] or world[yi][xi] == world[11][8] or world[yi][xi] == world[11][9] or world[yi][xi] == world[12][9] or world[yi][xi] == world[10][8] or world[yi][xi] == world[12][12] or world[yi][xi] == world[12][15] or world[yi][xi] == world[12][16] or world[yi][xi] == world[11][16] or world[yi][xi] == world[12][20] or world[yi][xi] == world[12][30] and i == 'extract':
                world[yi][xi] = Back.LIGHTWHITE_EX + '    '
                countrock += 1
            return countrock, countwood
        world[yi][xi] = Back.LIGHTWHITE_EX + '    '
        world[ym][xm] = Back.LIGHTWHITE_EX + '    '
        world[yb][xb] = Back.LIGHTWHITE_EX + '    '
        world[yc][xc] = Back.LIGHTWHITE_EX + '    '
