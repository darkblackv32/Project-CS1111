...
def collect(option):
    ...
    if world[yi][xi] == world[12][7] or world[yi][xi] == world[11][7] or world[yi][xi] == world[12][8] or world[yi][
        xi] == world[11][8] or world[yi][xi] == world[11][9] or world[yi][xi] == world[12][9] or world[yi][xi] == \
            world[10][8] or world[yi][xi] == world[12][12] or world[yi][xi] == world[12][15] or world[yi][xi] == \
            world[12][16] or world[yi][xi] == world[11][16] or world[yi][xi] == world[12][20] or world[yi][xi] == \
            world[12][30]:
        world[yi][xi] = Back.LIGHTWHITE_EX + '    '
        countrock += 1

    print("Stone blocks:", countrock)
