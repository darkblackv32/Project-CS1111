...
def draw_world2():  # seleccionamos las filas que queremos pintar y el numero de columnas que pintaremos, y cambiamos
    ...
    for i in range(13, 14):
        ...
        #
        world2[7][37] = Back.RED + '    '
        world2[8][37] = Back.RED + '    '
        world2[9][37] = Back.RED + '    '
        world2[10][37] = Back.RED + '    '
        world2[11][37] = Back.RED + '    '
        world2[12][37] = Back.RED + '    '
        world2[6][34] = Back.GREEN + '    '
        world2[6][35] = Back.GREEN + '    '
        world2[6][36] = Back.GREEN + '    '
        world2[6][37] = Back.GREEN + '    '
        world2[6][38] = Back.GREEN + '    '
        world2[6][39] = Back.GREEN + '    '
        world2[6][40] = Back.GREEN + '    '
        world2[5][35] = Back.GREEN + '    '
        world2[5][36] = Back.GREEN + '    '
        world2[5][37] = Back.GREEN + '    '
        world2[5][38] = Back.GREEN + '    '
        world2[5][39] = Back.GREEN + '    '
        world2[4][36] = Back.GREEN + '    '
        world2[4][37] = Back.GREEN + '    '
        world2[4][38] = Back.GREEN + '    '
        world2[3][37] = Back.GREEN + '    '

        #
        world2[10][39] = Back.RED + '    '
        world2[11][39] = Back.RED + '    '
        world2[12][39] = Back.RED + '    '
        world2[9][38] = Back.GREEN + '    '
        world2[9][39] = Back.GREEN + '    '
        world2[9][40] = Back.GREEN + '    '
        world2[8][39] = Back.GREEN + '    '
